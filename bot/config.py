...
class Messages:
    ...
    HELP_MSG = [
        ".",
        "**Puuppubot**\n__Aku bisa mengupload file dari direct link atau telegram ke google drive milikmu. Kamu hanya perlu login, kemudian kirim kepadaku file dari direct link or dari telegram.__\n\nAku punya fitur lainnya lhoo... ! Pengen tau ? Kalau emang pengen tau, kamu bisa klik tanda panah di bawah. Klik dengan hati-hati ya :).",
